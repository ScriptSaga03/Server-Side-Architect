...
2. Problem 2: "User Blocking & Account Suspension Guard"
Scenario
Aapke mock array data mein kuch users ka isBlocked: true hai.

Tasks
/api/login route par user email aur password bhejta hai.

Sabse pehle user ko email se find karein. Agar user nahi milta, toh 404 Not Found throw karein.

Password verify karein. Agar wrong password hai, toh 401 Unauthorized throw karein.

Agar user mil jata hai aur password bhi sahi hai, lekin isBlocked === true hai, toh 403 Forbidden status code ke saath error throw karein: "Your account has been suspended. Please contact support.".
